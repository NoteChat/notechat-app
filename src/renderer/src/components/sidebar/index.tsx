...
import { eraseCookie, getCookie } from '@renderer/utils'
  ...
  return (
    <div className={classnames(style['sidebar'])}>
      <div className={style['sidebar-menu']}>
        ...
        <Link to="/document">
          <MenuItem
            className={activeClass('/document')}
      ...
      <div className={style['settings']}>
        ...
        <ChangeLanguage />
        <Link to="https://notechat.xyz/document/tutorials" className="cursor-pointer flex items-center" title={t('helpDocs.label')} target="_blank">
