  ...
  ({ children, className, ...props }, forwardedRef) => {
    return (
      <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content className={classNames(className, style.DropdownMenuContent)} {...props} ref={forwardedRef}>
          {children}
...
export const DropdownMenuCheckboxItem = React.forwardRef<any, any>(
  ({ children, className, ...props }, forwardedRef) => {
    return (
      <DropdownMenuPrimitive.CheckboxItem className={classNames(className, style.DropdownMenuCheckboxItem)} {...props} ref={forwardedRef}>
        {children}
...
export const DropdownMenuRadioItem = React.forwardRef<any, any>(
  ({ children, className, ...props }, forwardedRef) => {
    return (
      <DropdownMenuPrimitive.RadioItem className={classNames(className, style.DropdownMenuRadioItem)} {...props} ref={forwardedRef}>
        {children}
        <DropdownMenuPrimitive.ItemIndicator className={style.DropdownMenuItemIndicator}>
          <CheckIcon />
        </DropdownMenuPrimitive.ItemIndicator>
